    ...
    <div className="glass-card w-full max-w-112.5 p-10 md:p-16 rounded-lg shadow-2xl">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 h-12 rounded-lg bg-gradient-to-r from-gray-700 to-gray-600 hover:from-gray-800 hover:to-gray-700 text-white font-medium transition-all duration-200 active:scale-95 shadow-lg shadow-gray-700/20 hover:shadow-gray-700/40"
        >
